...
public class ListaEncadeada {
    ...
    StringNoSimples primeiro;
    StringNoSimples ultimo;
    int numero_nos = 0;
    ...
    void insereNo_fim(StringNoSimples novoNo) {
        novoNo.prox = null;
        if (primeiro == null) {
            primeiro = novoNo;
        }
    ...
    void insereNo_inicio(StringNoSimples novoNo) {
    ...
    void insereNo_posicao(StringNoSimples novoNo, int posicao) {
        StringNoSimples temp_no = primeiro;
    ...
    StringNoSimples buscaNo(String buscaValor) {
        int i = 0;
        StringNoSimples temp_no = primeiro;
        while (temp_no != null) {
    ...
    void excluiNo(String valor) {
        StringNoSimples temp_no = primeiro;
        StringNoSimples anterior_no = null;
